...
namespace App\Tests\CashApplication;
...
class CashApplicationProductTest extends AppTestCase
{
    public function testInstall(): void
    {
        ...
        self::getService('test.product_installer')->install(Product::where('name', 'Cash Application')->one(), $company);

        // verify the settings were created
        $settings = CashApplicationSettings::oneOrNull();
        $this->assertInstanceOf(CashApplicationSettings::class, $settings);
