...
class TranslatorTest extends MockeryTestCase
{
    private function getTranslator(): Translator
    {
        ...
        $translator->setDataDir(__DIR__.'/locales');
    ...
    public function testTranslate(): void
    {
        ...
        // fallback phrase
        $this->assertEquals('{{field_name}} is invalid', $translator->translate('pulsar.validation.failed', [], ''));
    }

    public function testTranslateParameterInjection(): void
    {
        $translator = $this->getTranslator();
        $translator->setLocale('en');
        ...
        // fallback phrase
        $this->assertEquals('Test is invalid', $translator->translate('pulsar.validation.failed', ['field_name' => 'Test'], ''));
    }
}
