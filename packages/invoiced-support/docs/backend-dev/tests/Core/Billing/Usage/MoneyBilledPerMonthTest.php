...
use App\Core\Billing\Usage\MoneyBilledPerMonth;
use App\Core\Billing\ValueObjects\MonthBillingPeriod;
use App\Tests\AppTestCase;

class MoneyBilledPerMonthTest extends AppTestCase
{
    ...
    private function getUsage(): MoneyBilledPerMonth
    {
        return self::getService('test.billing_usage_factory')->get(UsageType::MoneyBilledPerMonth);
    }
