...
class InvoicesPerMonthTest extends AppTestCase
{
    ...
    private function getUsage(): InvoicesPerMonth
    {
        return self::getService('test.billing_usage_factory')->get(UsageType::InvoicesPerMonth);
    }
