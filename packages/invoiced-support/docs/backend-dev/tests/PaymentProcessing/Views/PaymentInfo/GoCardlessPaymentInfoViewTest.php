...
class GoCardlessPaymentInfoViewTest extends AppTestCase
{
    ...
    {
        $method = PaymentMethod::instance(self::$company, PaymentMethod::DIRECT_DEBIT);
        $view = self::getService('test.payment_method_view_factory')->getPaymentInfoView($method, GoCardlessGateway::ID);
        $this->assertInstanceOf(GoCardlessPaymentInfoView::class, $view);
