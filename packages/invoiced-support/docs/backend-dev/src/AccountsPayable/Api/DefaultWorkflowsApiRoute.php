 ...
 */
class DefaultWorkflowsApiRoute extends AbstractEditModelApiRoute
{
    ...
    {
        $context = $context->withRequestParameters(['default' => (bool) $context->request->attributes->get('default')]);
