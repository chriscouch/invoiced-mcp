...
class AffirmPaymentView extends AbstractPaymentView implements LoggerAwareInterface
{
    ...
    {
        return $merchantAccount && $merchantAccount->tenant()->features->has('allow_affirm') && $merchantAccount->settings->affirm?->id;
    }
    ...
    {
        return 'customerPortal/paymentMethods/paymentForms/affirm.twig';
    }
