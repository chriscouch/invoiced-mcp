 ...
 */
class StripeAchPaymentInfoView extends AbstractPaymentInfoView implements LoggerAwareInterface
{
    ...
    public function render(Company $company, PaymentMethod $paymentMethod, ?MerchantAccount $merchantAccount, TokenizationFlow $flow): string
    {
        ...
        try {
            $clientSecret = $this->stripeGateway->createSetupIntent($merchantAccount, $customer, $flow, ['us_bank_account']);
        ...
        return $this->twig->render(
            'customerPortal/paymentMethods/paymentInfoForms/achStripe.twig',
            [
