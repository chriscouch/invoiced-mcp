...
/**
 * @extends AbstractCreateModelApiRoute<Customer>
 */
class CreateCustomerRoute extends AbstractCreateModelApiRoute
{
    ...
    public function buildResponse(ApiCallContext $context): mixed
    {
        ...
        if (isset($requestParameters['disabled_payment_methods'])) {
            $disabledPaymentMethods = (array) $requestParameters['disabled_payment_methods'];
        ...
        // create any disabled payment methods
        if ($disabledPaymentMethods) {
            foreach ($disabledPaymentMethods as $method) {
