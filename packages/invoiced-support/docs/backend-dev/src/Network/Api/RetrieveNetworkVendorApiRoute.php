 ...
 */
class RetrieveNetworkVendorApiRoute extends AbstractRetrieveModelApiRoute
{
    ...
    public function buildResponse(ApiCallContext $context): array
    {
        ...
        if ($connection->customer_id != $this->tenant->get()->id) {
            throw $this->modelNotFoundError();
        }

        return $this->buildConnectionArray($connection, $connection->vendor);
    }
}
