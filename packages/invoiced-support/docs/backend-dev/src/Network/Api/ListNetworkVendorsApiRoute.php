 ...
 */
class ListNetworkVendorsApiRoute extends AbstractListModelsApiRoute
{
    ...
    public function buildQuery(ApiCallContext $context): Query
    {
        ...
        $query->join(Company::class, 'vendor_id', 'Companies.id')
    ...
    public function buildResponse(ApiCallContext $context): array
    {
        ...
        foreach ($connections as $connection) {
            $result[] = $this->buildConnectionArray($connection, $connection->vendor);
        }
