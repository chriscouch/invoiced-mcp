...
class CreditNoteAccountingSyncRoute extends AbstractAccountingSyncRoute
{
    ...
    public static function transform(array $input, Company $company, string $accountingSystem = ''): AccountingCreditNote
    {
        ...
        return TransformerHelper::makeCreditNote($integrationType, $input, $company);
    }
}
