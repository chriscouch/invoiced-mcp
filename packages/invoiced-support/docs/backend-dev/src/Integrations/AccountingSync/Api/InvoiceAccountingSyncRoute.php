...
class InvoiceAccountingSyncRoute extends AbstractAccountingSyncRoute
{
    ...
    public static function transform(array $input, Company $company, string $accountingSystem = ''): AccountingInvoice
    {
        ...
        return TransformerHelper::makeInvoice($integrationType, $input, $company);
    }
}
