...
class QuickBooksPaymentExtractor extends AbstractQuickBooksExtractor
{
    /**
    ...
    public function getObjects(AccountingSyncProfile $syncProfile, ReadQuery $query): Generator
    {
        ...
        try {
            $page = 1;
            do {
                $objects = $this->quickBooksApi->query(QuickBooksApi::PAYMENT, $page, $query);
