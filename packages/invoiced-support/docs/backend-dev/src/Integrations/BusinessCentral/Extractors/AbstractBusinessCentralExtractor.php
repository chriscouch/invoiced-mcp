...
abstract class AbstractBusinessCentralExtractor implements ExtractorInterface
{
    protected OAuthAccount $account;

    public function __construct(
        protected BusinessCentralApi $businessCentralApi,
    ) {
    }
    ...
    public function getObject(string $objectId): AccountingJsonRecord
    {
        try {
            // TODO
//            $object = $this->businessCentralApi->get('TODO', $objectId);
            $object = (object) [];
