...
class IntacctOrderEntryInvoiceReader extends AbstractIntacctReader
{
    ...
    public function __construct(
        ...
        IntacctOrderEntryInvoiceTransformer $transformer,
    ...
    {
        return 'intacct_order_entry_invoice';
    }

    protected function getDisplayName(AccountingSyncProfile $syncProfile): string
    {
        return 'Order Entry Invoices ('.$this->documentType.') from Intacct';
    }
    ...
    {
        foreach ($syncProfile->invoice_types as $type) {
