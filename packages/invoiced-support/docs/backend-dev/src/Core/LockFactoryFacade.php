 ...
 * @deprecated
 */
class LockFactoryFacade extends Facade
{
    ...
    /**
     * Gets an instance of the lock factory.
     */
    public static function get(): LockFactory
    {
        if (!self::$instance) {
            self::$instance = self::$container->get(self::class); /* @phpstan-ignore-line */
        }

        return self::$instance->lockFactory; /* @phpstan-ignore-line */
    }
}
