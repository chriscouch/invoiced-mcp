...
use App\Core\Orm\Validation\Alpha;
use App\Core\Orm\Validation\AlphaDash;
use App\Core\Orm\Validation\AlphaNumeric;
use App\Core\Orm\Validation\Boolean;
use App\Core\Orm\Validation\Callables;
use App\Core\Orm\Validation\Date;
use App\Core\Orm\Validation\Email;
use App\Core\Orm\Validation\Encrypt;
use App\Core\Orm\Validation\Enum;
use App\Core\Orm\Validation\Ip;
use App\Core\Orm\Validation\Matching;
use App\Core\Orm\Validation\MySqlDatetime;
use App\Core\Orm\Validation\Numeric;
use App\Core\Orm\Validation\Password;
use App\Core\Orm\Validation\Range;
use App\Core\Orm\Validation\Required;
use App\Core\Orm\Validation\Strings;
use App\Core\Orm\Validation\Timestamp;
use App\Core\Orm\Validation\Timezone;
use App\Core\Orm\Validation\Unique;
use App\Core\Orm\Validation\Url;
...
final class Validator
{
    ...
    private function getRule(string $name): ValidationRuleInterface
    {
        if (!isset(self::$instances[$name])) {
            ...
            /** @var ValidationRuleInterface $class */
