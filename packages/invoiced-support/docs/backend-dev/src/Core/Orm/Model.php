...
abstract class Model implements ArrayAccess
{
    ...
    {
        // Any calls to unknown static methods should be deferred to
        // the query. This allows calls like User::where()
        // to replace User::query()->where().
        return call_user_func_array([static::query(), $name], $parameters); /* @phpstan-ignore-line */
    }
    ...
    public function toArray(): array
    {
        ...
        foreach ($result as $k => &$value) {
            ...
            // Convert enums to a string value.
    ...
    public static function query(): Query
    {
        ...
        return new Query(new static()); /* @phpstan-ignore-line */
    }
     ...
     * @internal
     */
    public function hydrateValue(string $name, mixed $value): void
    {
        // type-cast the value because it came from the database
    ...
    public function relation(string $k): Model|array|null
    {
        if (!array_key_exists($k, $this->_relationships)) {
            /** @var Property $property */
            $property = static::definition()->get($k);
            $relation = Relationship::make($this, $property);
    ...
    {
        EventManager::listen(static::class, ModelCreating::getName(), $listener, $priority);
        EventManager::listen(static::class, ModelUpdating::getName(), $listener, $priority);
    }
    ...
    {
        EventManager::listen(static::class, ModelCreated::getName(), $listener, $priority);
        EventManager::listen(static::class, ModelUpdated::getName(), $listener, $priority);
    }
    ...
    public static function beforePersist(callable $listener, int $priority = 0): void
    {
        EventManager::listen(static::class, ModelCreating::getName(), $listener, $priority);
        EventManager::listen(static::class, ModelUpdating::getName(), $listener, $priority);
        EventManager::listen(static::class, ModelDeleting::getName(), $listener, $priority);
    }
    ...
    public static function afterPersist(callable $listener, int $priority = 0): void
    {
        EventManager::listen(static::class, ModelCreated::getName(), $listener, $priority);
        EventManager::listen(static::class, ModelUpdated::getName(), $listener, $priority);
        EventManager::listen(static::class, ModelDeleted::getName(), $listener, $priority);
    }
