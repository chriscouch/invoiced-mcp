...
!(function (a, b) {
    ...
    for (g in j)
        if (((m = j[g]), null != f.style[g])) {
            (k = m), (l = !0);
            break;
        }
    if ((null != f.style.animationName && (d = !0), !d))
        for (n = 0, o = e.length; o > n; n++)
            if (((h = e[n]), null != f.style['' + h + 'AnimationName'])) {
                switch (h) {
                    case 'Webkit':
                        c = 'webkitAnimationEnd';
                        break;
                    case 'Moz':
                        c = 'animationend';
                        break;
    ...
    return (
        (b = (function () {
            function a(a) {
                var b, e, f, g;
                (b = this.constructor._defaultOptions), (this.options = {}), (this.loaded = !1);
                for (e in b) (g = b[e]), (this.options[e] = null != a[e] ? a[e] : g);
                    ...
                    (f = (function (a) {
                        return function () {
                            return (
                                ...
                                (a._loadingHtmlElem.className += ' pg-loaded'),
                                d && a._loadingHtmlElem.removeEventListener(c, f),
                                a._loadingHtmlToDisplay.length > 0 ? a._changeLoadingHtml() : void 0
                            );
                        };
                    })(this)),
                    null != this._loadingHtmlElem &&
                        (d ? this._loadingHtmlElem.addEventListener(c, f) : f(),
                        (this._loadingHtmlListener = (function (a) {
                            return function () {
                                return (
                                    (a._readyToShowLoadingHtml = !0),
                                    (a._loadingHtmlElem.className = a._loadingHtmlElem.className.replace(
                                        ' pg-loading ',
                                        '',
                                    )),
                                    l && a._loadingHtmlElem.removeEventListener(k, a._loadingHtmlListener),
                                    a._loadingHtmlToDisplay.length > 0 ? a._changeLoadingHtml() : void 0
                                );
                            };
                        })(this)),
                        (this._removingHtmlListener = (function (a) {
                            return function () {
                                return (
                                    ...
                                    l
                                        ? (a._loadingHtmlElem.removeEventListener(k, a._removingHtmlListener),
                                          a._loadingHtmlElem.addEventListener(k, a._loadingHtmlListener))
            ...
            return (
                        ...
                        null != this._loadingElem
                            ? this.loaded || a
                                ...
                                : ((b = (function (a) {
                                      return function () {
                                          return (
                                              a._loadingElem.removeEventListener(c, b),
                                  ...
                                  this._loadingHtmlElem.addEventListener(c, b))
                            : void 0
                    );
                }),
                ...
                (a.prototype.updateLoadingHtml = function (a, b) {
                    ...
                    return (
                        b
                            ? ((this._loadingHtmlToDisplay = [a]), (this._readyToShowLoadingHtml = !0))
                ...
                (a.prototype._changeLoadingHtml = function () {
                    return (
                        (this._readyToShowLoadingHtml = !1),
                        this._loadingHtmlElem.removeEventListener(k, this._loadingHtmlListener),
                        this._loadingHtmlElem.removeEventListener(k, this._removingHtmlListener),
                        (this._loadingHtmlElem.className = this._loadingHtmlElem.className
                            .replace(' pg-loading ', '')
                            .replace(' pg-removing ', '')),
                        l
                            ? ((this._loadingHtmlElem.className += ' pg-removing '),
                              this._loadingHtmlElem.addEventListener(k, this._removingHtmlListener))
                ...
                (a.prototype._finish = function () {
                    ...
                    return (
                        ...
                        (a = (function (b) {
                            return function () {
                                return (
                                    document.body.removeChild(b._loadingElem),
                                    (document.body.className = document.body.className.replace('pg-loading', '')),
                                    d && b._loadingElem.removeEventListener(c, a),
                                    (b._loadingElem = null)
                                );
                            };
                        })(this)),
                        d
                            ? ((this._loadingElem.className += ' pg-loaded'), this._loadingElem.addEventListener(c, a))
                            : a()
                    );
                }),
                a
