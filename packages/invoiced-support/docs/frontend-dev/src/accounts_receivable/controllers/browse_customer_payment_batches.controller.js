(function () {
    ...
    angular
        ...
        .controller('BrowseCustomerPaymentBatchesController', BrowseCustomerPaymentBatchesController);

    BrowseCustomerPaymentBatchesController.$inject = [
        '$scope',
        '$controller',
        'Core',
    ...
    function BrowseCustomerPaymentBatchesController(
        $scope,
        $controller,
        Core,
        CustomerPaymentBatch,
