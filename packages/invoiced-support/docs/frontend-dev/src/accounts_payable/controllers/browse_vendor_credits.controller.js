(function () {
    ...
    angular.module('app.accounts_payable').controller('BrowseVendorCreditsController', BrowseVendorCreditsController);

    BrowseVendorCreditsController.$inject = [
        '$scope',
        '$state',
        '$modal',
        '$controller',
    ...
    function BrowseVendorCreditsController(
        $scope,
        $state,
        $modal,
        $controller,
        ...
        $scope.model = VendorCredit;
        $scope.modelTitleSingular = 'Vendor Credit';
        $scope.modelTitlePlural = 'Vendor Credits';
        ...
        function postFindAll(vendorCredits) {
            $scope.vendorCredits = vendorCredits;
        }
        ...
        function noResults() {
            return $scope.vendorCredits.length === 0;
        }
